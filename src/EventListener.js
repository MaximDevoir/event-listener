/**
 * EventListener - A solution to add and remove events from a target while being
 *  compatible with modern browsers, and their use of the
 *
...
export default class EventListener {
   ...
   * @param {Function} listener   Listener to execute when event is fired from
   * target
   ...
   * @param {Function} listener   Listener to remove from event target
   * @param {Boolean}  useCapture useCapture
   */
